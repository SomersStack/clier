...
**Individual services:**
- Start: `clier service start <name>`
- Stop: `clier service stop <name>`
- Restart: `clier service restart <name>`

**Entire daemon:** **Run `clier docs commands` and read before using `clier restart` or `clier reload`**
